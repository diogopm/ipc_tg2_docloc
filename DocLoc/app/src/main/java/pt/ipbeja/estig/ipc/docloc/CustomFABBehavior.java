...
public class CustomFABBehavior extends FloatingActionButton.Behavior
{
                               ...
                               View target, int dxConsumed, int dyConsumed, int dxUnconsumed, int dyUnconsumed)
    {
        ...
        if (dxConsumed > 0 && !this.mIsAnimatingOut && child.getVisibility() == View.VISIBLE)
        {
            animateOut(child);
        ...
        if (Build.VERSION.SDK_INT >= 14)
        {
            ViewCompat.animate(button).scaleX(0.0F).scaleY(0.0F).alpha(0.0F)
                    ...
                    .setListener(new ViewPropertyAnimatorListener()
                    {
                        ...
                        {
                            CustomFABBehavior.this.mIsAnimatingOut = true;
                        }

                        public void onAnimationCancel(View view)
                        {
                            CustomFABBehavior.this.mIsAnimatingOut = false;
                        }
